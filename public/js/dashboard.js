...
async function getContent() {
    console.log( "NADA QUE VERw");
    const html = await fetch('http://www.francobenitez.ml/expenses/create').then(res => res.text());
    return html;
}
...
async function drawChart() {
    console.log( "NADA QUE VER");
    const http = await fetch('http://www.francobenitez.ml/expenses/getExpensesJSON')
        .then(json => json.json())
        .then(res => res);
